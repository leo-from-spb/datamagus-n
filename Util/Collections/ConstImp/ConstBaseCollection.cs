...
public abstract class ConstBaseCollection<T> : ImmCollection<T>
{
...
/// </summary>
/// <typeparam name="T">element type.</typeparam>
public class ConstEmptySet<T> : ConstBaseCollection<T>, ImmOrderSet<T>
{
    /// <summary>
    /// The empty list and set.
    /// </summary>
    public static readonly ConstEmptySet<T> Instance = new ConstEmptySet<T>();
...
/// </summary>
/// <typeparam name="T">element type.</typeparam>
public class ConstEmptySortedSet<T> : ConstEmptySet<T>, ImmSortedSet<T>
    where T : IComparable<T>
{
    /// <summary>
    /// The empty list and set.
    /// </summary>
    public new static readonly ConstEmptySortedSet<T> Instance = new ConstEmptySortedSet<T>();
}
...
public class ConstSingletonSet<T> : ConstBaseCollection<T>, ImmOrderSet<T>
{
    /// <summary>
    /// The single element.
    /// </summary>
    ...
    public ConstSingletonSet(T element)
    {
    ...
    {
        private readonly ConstSingletonSet<E> collection;

        private sbyte position = -1;

        internal SingletonEnumerator(ConstSingletonSet<E> collection)
        {
...
public class ConstSingletonSortedSet<E> : ConstSingletonSet<E>, ImmSortedSet<E>
    where E : IComparable<E>
{
    public ConstSingletonSortedSet(E element) : base(element) { }
}
