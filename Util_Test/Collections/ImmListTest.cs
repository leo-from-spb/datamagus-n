...
{
    [Test]
    public void Basic_Constructor1a()
    {
        var list = new ImmList<ulong>(new[] { 26uL, 42uL, 74uL }, false);
        BasicTest(list);
    }

    [Test]
    public void Basic_Constructor1c()
    {
        var array = new[] { 26uL, 42uL, 74uL };
        var list  = new ImmList<ulong>(array, true);
        array[0] = 666uL;
        array[1] = 999uL;
        BasicTest(list);
    }
    ...
    [Test]
    public void Basic_Constructor2()
    {
        var array   = new[] { 26uL, 42uL, 74uL };
        var segment = new ArraySegment<ulong>(array);
        var list    = new ImmList<ulong>(segment);
        BasicTest(list);
    }
