...
[TestFixture]
public class ImmHashDictionaryTest
{
    ...
    public void Basic_1()
    {
        ...
        var dictionary = new ImmHashDictionary<long,long>(entries);
    ...
    public void NullableKeyNullableValue()
    {
        ...
        var dictionary = new ImmHashDictionary<string?,string?>(entries);
    ...
    private static ImmHashDictionary<ulong, string> prepareSimpleDictionary3()
    {
        var entries    = new[] { kvp(1001uL, "einz"), kvp(2002uL, "zwei"), kvp(3003uL, "drei") };
        var dictionary = new ImmHashDictionary<ulong,string>(entries);
        return dictionary;
    }
