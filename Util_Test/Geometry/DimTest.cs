...
public class DimTest
{
    ...
    (
        () => 0.mk.ToString().ShouldBe("0"),
        () => 1.mk.ToString().ShouldBe("1")
    );

    [Test]
    public void ToString_GroupSeparator() => Verify
    (
        () => 3.mm.ToString().ShouldBe("3 000"),
        () => 5.cm.ToString().ShouldBe("50 000")
    );
    ...
    (
        () => 1.mm.ShouldBe(new Dim(1, Unit.mm)),
        () => 2.mm.ShouldBe(new Dim(2, Unit.mm)),
        () => 3.mm.ShouldBe(new Dim(3, Unit.mm)),
        () => 4.mm.ShouldBe(new Dim(4, Unit.mm)),
        () => 5.mm.ShouldBe(new Dim(5, Unit.mm)),
        () => 6.mm.ShouldBe(new Dim(6, Unit.mm)),
        () => 7.mm.ShouldBe(new Dim(7, Unit.mm)),
        () => 8.mm.ShouldBe(new Dim(8, Unit.mm)),
        () => 9.mm.ShouldBe(new Dim(9, Unit.mm)),

        () => 1.cm.ShouldBe(new Dim(10, Unit.mm)),
        () => 2.cm.ShouldBe(new Dim(20, Unit.mm)),
        () => 3.cm.ShouldBe(new Dim(30, Unit.mm)),
        () => 4.cm.ShouldBe(new Dim(40, Unit.mm)),
        () => 5.cm.ShouldBe(new Dim(50, Unit.mm)),
        () => 6.cm.ShouldBe(new Dim(60, Unit.mm)),
        () => 7.cm.ShouldBe(new Dim(70, Unit.mm)),
        () => 8.cm.ShouldBe(new Dim(80, Unit.mm)),
        () => 9.cm.ShouldBe(new Dim(90, Unit.mm))
    );
